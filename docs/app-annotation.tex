...
class SQLiteDatabase{
  public void execSQL (@Sink(FlowPermission.DATABASE) @Source(FlowPermission.ANY) String sql);
}
\end{Verbatim}
Use of the API
\begin{Verbatim}
...
class Camera$PictureCallback{
  //data: a byte array of the picture data
   void onPictureTaken 
      (@Source(FlowPermission.CAMERA) @Sink(FlowPermission.ANY) byte[] data, 
             @Source(FlowPermission.CAMERA) @Sink(FlowPermission.ANY)  Camera camera);
}
\end{Verbatim}
...
(@Source(FlowPermission.CAMERA) byte[] data, @Source(FlowPermission.CAMERA) Camera camera){
