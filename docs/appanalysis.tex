...
class TelephonyManager {
    public @Sources(SpartaPermission.PHONE_NUMBER) String getLine1Number();
    public @Sources(SpartaPermission.IMEI) String getDeviceId();
}
\end{Verbatim}
...
\begin{alltt}
    ...
    @Sinks(INTERNET) String url = "http://bazinga.com/";
\end{alltt}
...
%  LocalWords:  PolySources PloySinks SpartaPermission SpartaPermission grep
