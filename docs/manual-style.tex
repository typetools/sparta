...
% The bar rarely appears in Java code and makes generics easier to write.
% (A disadvantage is that this violates the group's convention about what
% \| means in other documents...)
\def\|#1|{\code{#1}}
