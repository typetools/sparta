...
\newcommand{\ReleaseInfo}{0.9.1 (1 May 2013)}
...
\newcommand{\srcnone}{\<Sources(\ttcbs)>}
\newcommand{\srcsome}{\<Sources(\ldots)>}

\newcommand{\sinknone}{\<Sinks(\ttcbs)>}
\newcommand{\sinksome}{\<Sinks(\ldots)>}
