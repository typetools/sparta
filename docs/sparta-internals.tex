...
group. Contact Werner or Mike to get the permission.  Also, if you are going to push changes, please add a .hgrc file to your home directory on the server.  The .hgrc file should contain:
\begin{Verbatim} 
[trusted]
users = wmdietl
groups = sparta
