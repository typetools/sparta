...
~/Documents/sparta/sparta-code/docs/manual.html  :  manual.html contains the directions needed to build and run sparta.  SPARTA is already build but you can still follow these instructions to build it from scratch.  Note, this file contains links to the checker-framework which is a dependency of SPARTA.  Also, manual.html normally needs to be built as per the instructions in ~/Documents/sparta/sparta-code/README
...
~/Documents/sparta/sparta-code : contains the actual sparta code
	...
	Please see ~/Documents/sparta/sparta-code/docs/manual.html for more info.  (Note if this file doesn't exist follow the instructions in ~/Documents/sparta/sparta-code/docs/README)
...
Please see
~/Documents/sparta/sparta-code/docs/manual.html for more in depth instructions. 