...
public class FlowUtil {
    ...
    public static List<FlowPermission> getSource(final AnnotationMirror am) {
        ...
        List<FlowPermission> sources = AnnotationUtils.getElementValueEnumArray(am, "value",
                FlowPermission.class, true);
        Set<FlowPermission> set = FlowUtil.allToAnySource(new HashSet<FlowPermission>(sources),
                false);
        return new ArrayList<>(set);
    }

    public static Set<FlowPermission> getSink(final AnnotationMirror annotationMirror,
            boolean replaceAny) {
     ...
     * @return
     */
    public static Set<FlowPermission> getSource(final AnnotationMirror annotationMirror,
            boolean replaceAny) {
        final Set<FlowPermission> sourceSet = new HashSet<FlowPermission>(
                getSource(annotationMirror));
        if (replaceAny) {
     ...
     * @return
     */
    public static Set<FlowPermission> getSourceOrEmpty(final AnnotationMirror annotationMirror,
            boolean replaceAny) {
    ...
    public static Set<FlowPermission> getSinkOrEmpty(final AnnotationMirror annotationMirror,
            boolean replaceAny) {
        if (annotationMirror == null) {
            return new HashSet<FlowPermission>();
        } else {
    ...
    public static AnnotationMirror createAnnoFromSink(final ProcessingEnvironment processingEnv,
            final Set<FlowPermission> sinks) {
    ...
    public static AnnotationMirror createAnnoFromSource(final ProcessingEnvironment processingEnv,
    ...
    public static Set<FlowPermission> replaceAnySink(final Set<FlowPermission> sinks,
            boolean inPlace) {
        return replaceAny(FlowPermission.class, FlowPermission.values(), sinks, inPlace);
    }

    public static Set<FlowPermission> replaceAnySource(final Set<FlowPermission> sources,
            boolean inPlace) {
        return replaceAny(FlowPermission.class, FlowPermission.values(), sources, inPlace);
    }

    public static Set<FlowPermission> allToAnySource(final Set<FlowPermission> sources,
            boolean inPlace) {
    ...
    private static <VALUE extends Enum<VALUE>> Set<VALUE> allToAny(final Class<VALUE> vc,
            final VALUE[] enumValues, final Set<VALUE> values, final boolean inPlace) {
