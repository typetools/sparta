...
public class IntentAnnotatedTypeFactory extends FlowAnnotatedTypeFactory {
    ...
    protected ListTreeAnnotator createTreeAnnotator() {
        ...
        implicits.addTreeKind(Tree.Kind.NULL_LITERAL, EMPTYINTENTEXTRAS);
        implicits.addTreeKind(Tree.Kind.INT_LITERAL, EMPTYINTENTEXTRAS);
        implicits.addTreeKind(Tree.Kind.LONG_LITERAL, EMPTYINTENTEXTRAS);
        implicits.addTreeKind(Tree.Kind.FLOAT_LITERAL, EMPTYINTENTEXTRAS);
        implicits.addTreeKind(Tree.Kind.DOUBLE_LITERAL, EMPTYINTENTEXTRAS);
        implicits.addTreeKind(Tree.Kind.BOOLEAN_LITERAL, EMPTYINTENTEXTRAS);
        implicits.addTreeKind(Tree.Kind.CHAR_LITERAL, EMPTYINTENTEXTRAS);
        implicits.addTreeKind(Tree.Kind.STRING_LITERAL, EMPTYINTENTEXTRAS);
