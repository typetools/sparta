...
class Use {
    ...
    void polyFlowMethod(@Source({}) @Sink(ANY) Cons bottom) {
        ...
        @Source(ANY) @Sink({}) String d = bottom.defaultReceiver(this.top);LinkedHashSet
    }
LinkedHashSet
    void polyFlowMethodFail(@Source({}) @Sink(ANY) Cons bottom) {
        ...
        //:: error: (assignment.type.incompatible)
        @Source({}) @Sink(ANY) String d = bottom.defaultReceiver(this.top);LinkedHashSet
    }
    void polyFlowReceiver(@Source({}) @Sink(INTERNET) Cons emptyInet,LinkedHashSet
            @Source(READ_SMS) @Sink(INTERNET) Cons readSMSInet,LinkedHashSet
...
LinkedHashSet
        ...
        @Source({}) @Sink(ANY) String c =  bottom.defaultReceiver(this.bottom);
        @Source(ANY) @Sink({}) String d = top.defaultReceiver(this.top);LinkedHashSet
    }
LinkedHashSet
    void polyFlowReceiverLubs(@Source({}) @Sink(INTERNET) Cons emptyInet,LinkedHashSet
            @Source(READ_SMS) @Sink(INTERNET) Cons readSMSInet,LinkedHashSet
            @Source({}) @Sink(ANY) Cons bottom,
            @Source(ANY) @Sink({}) Cons top) {
...
LinkedHashSet
        @Source({}) @Sink(ANY) String c =  bottom.defaultReceiver(this.bottom);
        @Source({}) @Sink(ANY) String d = bottom.defaultReceiver(this.bottom);LinkedHashSet
    }
}
