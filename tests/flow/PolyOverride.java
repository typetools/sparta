...
class PolyOverride {
    ...
    class ObjectComparator implements Comparator<@Source(CoarseFlowPermission.ACCESS_FINE_LOCATION) Object> {
        // TODO: We would want the following to be a valid override:
        @SuppressWarnings("flow")
        public @Source(CoarseFlowPermission.ACCESS_FINE_LOCATION) int compare(@Source(CoarseFlowPermission.ACCESS_FINE_LOCATION) Object left,
                @Source(CoarseFlowPermission.ACCESS_FINE_LOCATION) Object right) {
            return 0;
        }
